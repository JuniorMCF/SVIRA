...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand d-flex text-dark" href="{{ url('main') }}">
                    {{--<div class="image-app">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right w-auto shadow p-0" id="navbarDropdown" aria-labelledby="navbarDropdownLbl">
                                @guest
                                    ...
                                    @endif
                                @else
                                    <a class="dropdown-item d-flex flex-nowrap align-items-center px-0 py-3"  href="{{route('citas')}}">
                                        <div class="flex-shrink-1 text-center  px-3"><i class="ion-ios-cloud-download-outline h1"></i></div>
                                        <div class="pl-0 pr-4">
                                            <h6 class="mb-0">Citas medicas</h6>
                                        </div>
                                    </a>
                                    <a class="dropdown-item d-flex flex-nowrap align-items-center px-0 py-3"  href="{{route('chats')}}">
                                        <div class="flex-shrink-1 text-center  px-3"><i class="ion-ios-cloud-download-outline h1"></i></div>
                                        <div class="pl-0 pr-4">
                                            <h6 class="mb-0">Chats</h6>
                                        </div>
                                    </a>
                                    <a class="dropdown-item d-flex flex-nowrap align-items-center px-0 py-3"  href="{{route('teleconsultas')}}">
                                        <div class="flex-shrink-1 text-center  px-3"><i class="ion-ios-cloud-download-outline h1"></i></div>
                                        <div class="pl-0 pr-4">
                                            <h6 class="mb-0">Teleconsultas</h6>
                                        </div>
                                    </a>
